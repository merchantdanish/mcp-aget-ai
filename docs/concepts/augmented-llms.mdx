...
<Tabs>
  ...
  <Tab title="Amazon Bedrock API">
    ```yaml mcp_agent.secrets.yaml
    # Configuration for Claude models through Bedrock
    anthropic:
      bedrock: true
      bedrock_settings:
  ...
  <Tab title="Vertex AI API">
    ```yaml mcp_agent.secrets.yaml
    # Configuration for Claude models through Vertex AI
    anthropic:
      vertexai: true
      vertexai_settings:
...
- **Azure OpenAI**: `AzureAugmentedLLM`
- **Amazon Bedrock**: `BedrockAugmentedLLM`
- **Google AI**: `GoogleAugmentedLLM`
- **Ollama**: `OllamaAugmentedLLM`
