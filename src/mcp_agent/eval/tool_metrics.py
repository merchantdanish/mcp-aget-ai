"""
Tool metrics measurement and analysis.

This module provides functions for analyzing tool usage, including:
- Measuring tool call frequency, success rates, and duration
- Extracting detailed tool call information including arguments and results
- Analyzing tool calls per task
"""
