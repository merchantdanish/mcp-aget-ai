"""
Base trace file structure analysis tools.

This module provides basic functions for analyzing the structure of trace files,
including categorizing spans by type and extracting metadata.
"""
...
from mcp_agent.eval.core import read_trace_file, separate_spans_by_id, organize_spans_by_parent
