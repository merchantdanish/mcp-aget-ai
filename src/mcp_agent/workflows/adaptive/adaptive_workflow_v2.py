"""
Adaptive Workflow V2 - Following Deep Research Architecture
"""
...
class AdaptiveWorkflowV2(AugmentedLLM[MessageParamT, MessageT]):
    """
    ...
    async def _execute_single_aspect(
        ...
        if aspect.use_predefined_agent and aspect.use_predefined_agent in self.available_agents:
