...
from mcp_agent.workflows.adaptive.memory_v2 import (
    MemoryManager,
    InMemoryBackend,
    FileSystemBackend,
    AdaptiveMemory,
...
class TestAdaptiveMemory:
    ...
    async def test_learn_from_execution(self):
        ...
        memory = ExecutionMemory(
            ...
            task_type=TaskType.RESEARCH,
            research_history=[["Found medical AI uses"], ["Identified key applications"]],
            subagent_results=[
                SubagentResult(
        ...
        research_patterns = adaptive.session_patterns["successful_approaches"]["research"]
...
class TestMemoryManager:
    ...
    async def test_list_executions_through_manager(self):
        ...
        assert all(exec_data["task_type"] == "research" for exec_data in executions.values())