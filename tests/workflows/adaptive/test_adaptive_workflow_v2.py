...
from mcp_agent.workflows.adaptive.memory_v2 import MemoryManager, InMemoryBackend, FileSystemBackend
...
class TestObjectiveExtraction:
    ...
    @pytest.mark.asyncio
    async def test_extract_objective_complex_message(self, mock_llm_factory, mock_context):
        ...
        mock_llm_instance.generate_str_mock.return_value = "Research quantum computing applications"
...
class TestPredefinedAgents:
    ...
    @pytest.mark.asyncio
    async def test_execute_with_predefined_augmented_llm(self, mock_llm_factory, mock_context):
...
class TestMessageHandling:
    ...
    @pytest.mark.asyncio
    async def test_format_research_history_with_messages(self, mock_llm_factory, mock_context):
...
class TestWorkflowIntegration:
    ...
    @pytest.mark.asyncio
    async def test_workflow_with_time_budget_exceeded(self, mock_llm_factory, mock_context):
