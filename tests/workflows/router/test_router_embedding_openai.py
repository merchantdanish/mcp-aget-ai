...
class TestOpenAIEmbeddingRouter:
    ...
    def test_initialization(self, setup_openai_context, mock_agent, test_function):
        ...
        with patch(
            ...
            assert router.embedding_model.model == "text-embedding-3-small"  # Default model
    ...
    @pytest.mark.asyncio
    async def test_create_with_custom_embedding_model(self, setup_openai_context, mock_agent):
    ...
    async def test_routing_functionality(self, setup_openai_context, mock_agent):
        ...
        with patch(
            ...
            router._route_with_embedding = AsyncMock(wraps=original_route_with_embedding)
    ...
    async def test_full_routing_flow(self, setup_openai_context, mock_agent):
        ...
        with patch(
            ...
            assert any(val == "test_server" or val == mock_agent for val in result_values)
    
    # Test 8: Integration with parent EmbeddingRouter methods
    @pytest.mark.asyncio
    async def test_integration_with_parent_methods(self, setup_openai_context, mock_agent):
